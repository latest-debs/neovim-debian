![neovim for Debian](.github/readme-header.png)

# neovim for Debian

[neovim/neovim](https://github.com/neovim/neovim) — A heavily refactored vim fork focused on extensibility and usability, with a built-in Lua scripting engine and LSP support. —
...
Or download a `.deb` from the [Releases](https://github.com/latest-debs/neovim-debian/releases) page:
...
- amd64, arm64, armhf, i386, ppc64el, riscv64, s390x — whichever
  architectures neovim/neovim actually publishes a Linux binary for
...
For issues with neovim itself, see
